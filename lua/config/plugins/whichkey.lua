return {
    {
        ...
        opts = {
            ...
            spec = {
                ...
                { "<leader>M", "<cmd>Lazy<cr>", desc = "Plugin Manager" },
...

                {
                    ...
                    {
                        "<leader>qq",
                        "<cmd>lua require('defaults').save_and_quit('single')<CR>",
                        desc = "Current Window",
                    },
                },

                {
                    ...
                    { "<leader>sg", "<cmd>lua require('telescope.extra').project_files()<cr>", desc = "Project Files" },
